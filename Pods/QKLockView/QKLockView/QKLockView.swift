...
//        self.backgroundColor = UIColor.grayColor()
        ...
        for i in 0...8 {
            ...
            btn.setImage(UIImage(named: "circle_normal"), forState: .Normal)
            btn.setImage(UIImage(named: "circle_select"), forState: .Selected)
            self.addSubview(btn)
...
//        self.lockView(self, didEndWithPassCode: passStr)
...
//extension QKLockView: QKLockViewDelegate{
//    func lockView<T>(lockView: QKLockView, didEndWithPassCode passcode: T) -> String {
//        lockView.password = passcode as? String
//        return lockView.password!
//    }
//}
